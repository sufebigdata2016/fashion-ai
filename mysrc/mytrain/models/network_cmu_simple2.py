...
from mysrc.mytrain.run.taskdesc import TASK_KEY_POINTS

KEY_POINTS = TASK_KEY_POINTS
...
class CmuNetwork(network_base.BaseNetwork):
    def setup(self):
        ...
        # .conv(1, 1, KEY_POINTS * 2, 1, 1, relu=False, name='conv5_5_CPM_L1'))
        ...
        (self.feed('conv4_4_CPM')
         ...
         .conv(1, 1, KEY_POINTS, 1, 1, relu=False, name='conv5_5_CPM_L2'))
        ...
        # .conv(1, 1, KEY_POINTS * 2, 1, 1, relu=False, name='Mconv7_stage2_L1'))
        ...
        (self.feed('concat_stage2')
         ...
         .conv(1, 1, KEY_POINTS, 1, 1, relu=False, name='Mconv7_stage2_L2'))
        ...
        # .conv(1, 1, KEY_POINTS * 2, 1, 1, relu=False, name='Mconv7_stage3_L1'))
        ...
        (self.feed('concat_stage3')
         ...
         .conv(1, 1, KEY_POINTS, 1, 1, relu=False, name='Mconv7_stage3_L2'))
        ...
        # .conv(1, 1, KEY_POINTS * 2, 1, 1, relu=False, name='Mconv7_stage4_L1'))
        ...
        (self.feed('concat_stage4')
         ...
         .conv(1, 1, KEY_POINTS, 1, 1, relu=False, name='Mconv7_stage4_L2'))
        ...
        # .conv(1, 1, KEY_POINTS * 2, 1, 1, relu=False, name='Mconv7_stage5_L1'))

        (self.feed('concat_stage5')
         .separable_conv(7, 7, 128, 1, rate=2, name='Mconv1_stage5_L2')
         .separable_conv(7, 7, 128, 1,  rate=2, name='Mconv2_stage5_L2')
         .separable_conv(7, 7, 128, 1,  rate=2, name='Mconv3_stage5_L2')
         .separable_conv(7, 7, 128, 1,  rate=2, name='Mconv4_stage5_L2')
         .separable_conv(7, 7, 128, 1, rate=2, name='Mconv5_stage5_L2')
         .separable_conv(1, 1, 128, 1, rate=2, name='Mconv6_stage5_L2')
         .separable_conv(1, 1, KEY_POINTS, 1, rate=2, relu=False, name='Mconv7_stage5_L2'))
        ...
        # .conv(1, 1, KEY_POINTS * 2, 1, 1, relu=False, name='Mconv7_stage6_L1'))

        (self.feed('concat_stage6')
         .separable_conv(7, 7, 128, 1, rate=2, name='Mconv1_stage6_L2')
         .separable_conv(7, 7, 128, 1, rate=2, name='Mconv2_stage6_L2')
         .separable_conv(7, 7, 128, 1, rate=2, name='Mconv3_stage6_L2')
         .separable_conv(7, 7, 128, 1, rate=2, name='Mconv4_stage6_L2')
         .separable_conv(7, 7, 128, 1, rate=2, name='Mconv5_stage6_L2')
         .separable_conv(1, 1, 128, 1, rate=2, name='Mconv6_stage6_L2')
         .separable_conv(1, 1, KEY_POINTS, 1, rate=2, relu=False, name='Mconv7_stage6_L2'))
    ...
    def loss_last(self):
        return [], self.get_output('Mconv7_stage6_L2')  # self.get_output('Mconv7_stage6_L1'),
