...
from tfpose.src.pose_dataset import get_dataflow_batch, DataFlowToQueue, CocoPose
from tfpose.src.pose_augment import set_network_input_wh, set_network_scale
from tfpose.src.common import get_sample_images
from tfpose.src.networks import get_network

from mysrc.mytrain.run.taskdesc import TASK_KEY_POINTS as KP
